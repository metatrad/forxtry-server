...
const Account = () => {
  ...
  const { userLoading, userAppErr, userServerErr, userAuth, userUpdate } =
    state;
  ...
  const [imagePreview, setImagePreview] = useState(
    userAuth?.image || accountImage
  );
  const [imageVPreview, setImageVPreview] = useState(
        ...
        <div className="account-settings">
          ...
          <div className="social-media-account">
            <h2>
              ...
              <a
                href="https://t.me/+okSu0B6i-2UwYTY0"
                className="telegram-account"
              >
                <FaTelegramPlane />
              </a>
            </h2>
          ...
          <form action="" className="form-info" onSubmit={formik.handleSubmit}>
            <div className="account-images-cover">
              ...
              <div className="verification-id">
                <h1>
                  Upload your verification ID here: <br />
                  <p>e.g: National ID card, drivers liscence, etc.</p>
                </h1>
                <label htmlFor="verification" className="v-img-label">
                  {" "}
                  <div className="verification-img">
                    {userData?.verification ? (
                      <img src={userData?.verification} />
                    ) : (
                      <img src={imageVPreview} />
                    )}
                  </div>
                </label>
                <input
                  type="file"
                  className="v-img-input"
                  id="verification"
                  accept="image/*"
          ...
          {confirmationModalVisible && (
            <div className="confirm-delete-account">
              ...
              <div className="buttons-confirm">
                ...
                <button className="no-delete" onClick={handleCancelDelete}>
                  No
                </button>
              </div>
            </div>
